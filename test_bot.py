...
class TestConfiguration(unittest.TestCase):
    ...
    def test_anastasia_mzarelua_is_in_team_roster(self):
        """TC-01-10: Anastasia Mzarelua is included in standup report tracking"""
        self.assertIn("U0BRJ4PA1UG", bot_module.TEAM_USER_IDS)
        self.assertEqual(bot_module.TEAM_MAPPING["U0BRJ4PA1UG"]["name"], "anastasia mzarelua")

    def test_oleksii_khoziainov_is_in_team_roster(self):
        """TC-01-11: Oleksii Khoziainov is included in standup report tracking"""
        self.assertIn("U0BSKK0LGQJ", bot_module.TEAM_USER_IDS)
        self.assertEqual(bot_module.TEAM_MAPPING["U0BSKK0LGQJ"]["name"], "Oleksii Khoziainov")
